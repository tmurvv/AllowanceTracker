    ...
    <section class="about" id="about">
        <div class="about__container">
            ...
            <p>This website was created by
                ...
                <a href="https://www.innotechcollege.com" target="_blank">InnoTech College</a> in Calgary, Alberta, Canada. The layout is fully responsive and is coded in HTML5, CSS, PHP, and JavaScript.
